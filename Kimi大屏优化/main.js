...
(function () {
    ...
    // CSS
    const css_css = [
        {key: '.chat-content-list', value: 'margin: 0px; max-width: 100%;', sleep: 0},
        {key: '.chat-editor', value: 'max-width: calc(100% - 30px); margin-bottom: 5px;', sleep: 0},
        {key: '.chat-bottom', value: 'display: none;', sleep: 0},
        {key: '.case-list', value: 'display: none;', sleep: 0},
    ];
    const css_del = [];
